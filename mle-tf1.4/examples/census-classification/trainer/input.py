...
def process_features(features):
    ...
    features['education_to_age_ratio'] = features['education_num'] / features['age']

    # clipping feature
    features['hours_per_week'] = tf.clip_by_value(features['hours_per_week'], clip_value_min=20, clip_value_max=60)

    # adding constructed features to metadata
    metadata.CONSTRUCTED_NUMERIC_FEATURE_NAMES += ['education_to_age_ratio']
    metadata.CONSTRUCTED_CATEGORICAL_FEATURE_NAMES_WITH_IDENTITY['capital_indicator'] = 2
